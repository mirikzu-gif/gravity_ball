...
│   │   └── movement.py          # Вращательное управление
│   └── utils/
...
- **← / →** — вращение мяча на земле и в воздухе
...
- В воздухе стрелки раскручивают мяч, но не толкают его напрямую
...
- **movement.apply_roll_torque** — крутит мяч на земле и в воздухе
